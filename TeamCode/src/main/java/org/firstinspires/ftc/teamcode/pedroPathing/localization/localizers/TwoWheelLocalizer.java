...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = 32 * Math.PI / 2000 / 25.4; // Inches per ticks not ticks per inches
    public static double STRAFE_TICKS_TO_INCHES = 32 * Math.PI / 2000 / 25.4; // Inches per ticks not ticks per inches
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(-0.472440945, 3.93700787, 0);
        strafeEncoderPose = new Pose(-4.2519685, -2.36220472, Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontLeftMotor"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontRightMotor"));
